<div class="container">
	<div class="row">
		<h1>プライバシーポリシー</h1>
		<p>エーアンドディー株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
		<h3>第１条（プライバシー情報）</h3>
		...
		<p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。<br>
			...
			社名：エーアンドディー株式会社<br>
			担当部署：総務部 忠鉢<br>
			Eメールアドレス：chubachi@attack-and-defense.xxx</p>
